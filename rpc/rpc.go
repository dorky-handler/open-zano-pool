...
func (r *RPCClient) Getblocks(height int64) (*GetBlockReply, error) {
	...
	return r.getBlockBy("getblockheaderbyheight", params1)
}
...
func (r *RPCClient) GetBlockh(method string, params interface{},params1 interface{}) (*JSONRpcResp, error) {
	...
	if rpcResp1.Result != nil {
		...
		err = json.Unmarshal(*rpcResp1.Result, &reply)
...
func (r *RPCClient) WalletCheck(params string) (bool) {
	...
	rpcResp, err := r.doPost("http://localhost:11212/json_rpc", "split_integrated_address", tempstrr)
	if err != nil {
		return false
	}
